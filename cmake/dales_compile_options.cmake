...
elseif( CMAKE_Fortran_COMPILER_ID MATCHES Cray )
  ecbuild_add_fortran_flags( "-e Z -e T -s real64 -ffree" )
  ecbuild_add_fortran_flags( "-O3" BUILD RELEASE )
  ecbuild_add_fortran_flags( "-O0 -g" BUILD DEBUG )
elseif( CMAKE_Fortran_COMPILER_ID MATCHES Flang|LLVMFlang|Clang )
  ecbuild_add_fortran_flags( "-cpp -fdefault-real-8 -fdefault-double-8 -O3 -funroll-loops -g" )
  ecbuild_add_fortran_flags( "-O3 -funroll-loops -g" BUILD RELEASE )
  ecbuild_add_fortran_flags( "-O0 -g" BUILD DEBUG )
endif()
