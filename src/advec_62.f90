     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(37.*(a(i,j,k)+a(i,j-1,k))-8.*(a(i,j+1,k)+a(i,j-2,k))+(a(i,j+2,k)+a(i,j-3,k)))&
             ...
             + ( &
             (rhobf_p * a(i,j,k+1) + a(i,j,k)) *(w0(i,j,k+1)+ w0(i-1,j,k+1)) &
             ) * inv4dzfk &
             )
     end do
  end do
      ...
      do j=2,j1
        do i=2,i1
          ...
          p(i,j,k)  = p(i,j,k)- ( &
              ...
              + ( &
                     (a(i,j,k) + rhobf_p * a(i,j,k+1) )*(w0(i,j,k+1)+w0(i-1,j,k+1)) &
                    -(a(i,j,k) + rhobf_m * a(i,j,k-1) )*(w0(i,j,k  )+w0(i-1,j,k  )) &
                ) * inv4dzfk &
                )
     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(37.*(a(i,j,k)+a(i,j-1,k))-8.*(a(i,j+1,k)+a(i,j-2,k))+(a(i,j+2,k)+a(i,j-3,k)))&
             ...
             + ( &
             (a(i,j,k) * dzf(k+1) + rhobf_p * a(i,j,k+1)*dzf(k)) * (w0(i,j,k+1)+w0(i-1,j,k+1)) / dzh(k+1) &
             ) * inv4dzfk &
             )
     end do
  end do
      ...
      do j=2,j1
        do i=2,i1
          ...
          p(i,j,k)  = p(i,j,k)- ( &
              ...
              + ( &
                     (a(i,j,k) * dzf(k+1) + rhobf_p * a(i,j,k+1) *dzf(k)) * (w0(i,j,k+1)+w0(i-1,j,k+1)) / dzh(k+1) &
                    -(a(i,j,k) * dzf(k-1) + rhobf_m * a(i,j,k-1) *dzf(k)) * (w0(i,j,k  )+w0(i-1,j,k  )) / dzh(k)   &                     
                ) * inv4dzfk &
                )
     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(37.*(a(i,j,k)+a(i,j-1,k))-8.*(a(i,j+1,k)+a(i,j-2,k))+(a(i,j+2,k)+a(i,j-3,k)))&
             ...
             +( &
             (w0(i,j,k+1)+w0(i,j-1,k+1)) *(rhobf_p * a(i,j,k+1)+a(i,j,k)) &                          
             ) * inv4dzfk  &
             )
     end do
  end do
      ...
      do j=2,j1
        do i=2,i1
          ...
          p(i,j,k)  = p(i,j,k)- ( &
                ...
                + ( &
                (w0(i,j,k+1)+w0(i,j-1,k+1))*(rhobf_p * a(i,j,k+1) + a(i,j,k))&
                -(w0(i,j,k) +w0(i,j-1,k))  *(rhobf_m * a(i,j,k-1) + a(i,j,k))&
                  ) * inv4dzfk  &
                  )
        end do
      end do
     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(37.*(a(i,j,k)+a(i,j-1,k))-8.*(a(i,j+1,k)+a(i,j-2,k))+(a(i,j+2,k)+a(i,j-3,k)))&
             ...
             +( &
             (w0(i,j,k+1)+w0(i,j-1,k+1)) * (rhobf_p * a(i,j,k+1)*dzf(k) + a(i,j,k)*dzf(k+1)) / dzh(k+1)&
             ) * inv4dzfk  &
             )
     end do
  end do
        ...
        do i=2,i1
          ...
          p(i,j,k)  = p(i,j,k)- ( &
                ...
                +(&
                  ...
                  + ( &
                  (w0(i,j,k+1)+w0(i,j-1,k+1)) * (rhobf_p * a(i,j,k+1) * dzf(k) + a(i,j,k) * dzf(k+1)) / dzh(k+1)&
                 -(w0(i,j,k)  +w0(i,j-1,k))   * (rhobf_m * a(i,j,k-1) * dzf(k) + a(i,j,k) * dzf(k-1)) / dzh(k)  &
                  ) * inv4dzfk  &
                  )
        end do
      end do
      ...
      do j=2,j1
        do i=2,i1
           ...
           p(i,j,k)  = p(i,j,k)- ( &
                ...
                + ( &
                      (a(i,j,k)+rhobh_p * a(i,j,k+1) )*(w0(i,j,k) + w0(i,j,k+1)) &
                     -(a(i,j,k)+rhobh_m * a(i,j,k-1) )*(w0(i,j,k) + w0(i,j,k-1)) &
                  )*inv4dzhk &
                  )
       end do
      end do
