...
!-----------------------------------------------------------------------------------------
SUBROUTINE initchem
  use modglobal, only : imax,jmax,i1,i2,ih, j1,j2,jh, k1, kmax, nsv, ifnamopt, fname_options, ifoutput, cexpnr,timeav_glob,btime,tres,iTimeInt,iTimeWicker
  ...
  if (iTimeInt/=iTimeWicker) then
    print *,"NAMCHEM: You are trying to use a time integration scheme that is not compatible with modchem."
    print *,"NAMCHEM: Use iTimeInt=1 for lchem=.true."
    stop "NAMCHEM: You are trying to use a time integration scheme that is not compatible with modchem."
  end if
