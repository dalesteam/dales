     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(10.*(a(i,j,k)-a(i,j-1,k))-5.*(a(i,j+1,k)-a(i,j-2,k))+(a(i,j+2,k)-a(i,j-3,k))) &
             ...
             + ( &
             w0(i,j,k+1) * (rhobf_p * a(i,j,k+1) + a(i,j,k)) &
             ) * inv2dzfk  &
             )
     end do
  end do
     ...
     do j=2,j1
        do i=2,i1
            ...
            p(i,j,k)  = p(i,j,k)- (  &
                ...
                + ( &
                  w0(i,j,k+1) * (rhobf_p * a(i,j,k+1) +  a(i,j,k)) &
                  -w0(i,j,k)  * (rhobf_m * a(i,j,k-1) +  a(i,j,k)) &
                  ) * inv2dzfk &
                  )
     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(10.*(a(i,j,k)-a(i,j-1,k))-5.*(a(i,j+1,k)-a(i,j-2,k))+(a(i,j+2,k)-a(i,j-3,k))) &
             ...
             + ( &
             w0(i,j,k+1) * (rhobf_p * a(i,j,k+1) * dzf(k) +  a(i,j,k) * dzf(k+1) ) / dzh(k+1) &
             ) * inv2dzfk  &
             )       
     end do
  end do
     ...
     do j=2,j1
        do i=2,i1
            ...
            p(i,j,k)  = p(i,j,k)- (  &
                ...
                + ( &
                w0(i,j,k+1) * (rhobf_p * a(i,j,k+1) * dzf(k) +  a(i,j,k) * dzf(k+1) ) / dzh(k+1) &
                -w0(i,j,k ) * (rhobf_m * a(i,j,k-1) * dzf(k) +  a(i,j,k) * dzf(k-1) ) / dzh(k) &
                  ) * inv2dzfk &
                  )
      end do
    end do
     ...
     do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(10.*(a(i,j,k)-a(i,j-1,k))-5.*(a(i,j+1,k)-a(i,j-2,k))+(a(i,j+2,k)-a(i,j-3,k)))&
             ...
             +(1./rhobf(k))*( &
             ( rhobf(k+1) * a(i,j,k+1)*dzf(k)   + rhobf(k)   * a(i,j,k)  *dzf(k+1) ) / dzh(k+1)  *( w0(i,j,k+1)+ w0(i-1,j,k+1) ) &
             ) / (4.*dzf(k)) &
             )
     end do
  end do
      ...
      do i=2,i1
        ...
        p(i,j,k)  = p(i,j,k)- ( &
            ...
            +(&
              ...
              +(1./rhobf(k))*( &
              ( rhobf(k+1) * a(i,j,k+1)*dzf(k)   + rhobf(k)   * a(i,j,k)  *dzf(k+1) ) / dzh(k+1)  *( w0(i,j,k+1)+ w0(i-1,j,k+1) ) &
              -( rhobf(k)  * a(i,j,k)  *dzf(k-1) + rhobf(k-1) * a(i,j,k-1)*dzf(k)   ) / dzh(k)    *( w0(i,j,k)  + w0(i-1,j,k)   ) &
              ) / (4. * dzf(k)) &
              )
      end do
    end do
     ...
     do i=2,i1      
        p(i,j,k)  = p(i,j,k)- ( &
             ...
             *(10.*(a(i,j,k)-a(i,j-1,k))-5.*(a(i,j+1,k)-a(i,j-2,k))+(a(i,j+2,k)-a(i,j-3,k)))&
             ...
             +(1./rhobf(k))*( &
             (w0(i,j,k+1)+w0(i,j-1,k+1)) * (rhobf(k+1) * a(i,j,k+1)*dzf(k) + rhobf(k) * a(i,j,k)*dzf(k+1)) / dzh(k+1) &
             ) / (4. * dzf(k)) &
             )
     end do
  end do
    ...
    do j=2,j1
      do i=2,i1      
        p(i,j,k)  = p(i,j,k)- ( &
              ...
              +(1./rhobf(k))*( &
              (w0(i,j,k+1)+w0(i,j-1,k+1)) * (rhobf(k+1) * a(i,j,k+1)*dzf(k) + rhobf(k) * a(i,j,k)*dzf(k+1)) / dzh(k+1) &
             -(w0(i,j,k)  +  w0(i,j-1,k)) * (rhobf(k-1) * a(i,j,k-1)*dzf(k) + rhobf(k) * a(i,j,k)*dzf(k-1)) / dzh(k) &
              ) / (4. * dzf(k)) &
              )
