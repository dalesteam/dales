...
contains
  ...
  !broadcast namelists
    ...
    call MPI_BCAST(lnonperiodbc_sv(1:1000)	,1000, MPI_LOGICAL	  , 0, commwrld, mpierr)
	! 			END
	!____________________
    ...
    call MPI_BCAST(lpercentchem           	,1	 , MPI_LOGICAL, 0, commwrld, mpierr)
    call MPI_BCAST(pc_chemrate(1:1000)		,1000, MY_REAL	  , 0, commwrld, mpierr)
	! 			END
	!____________________
