...
contains
  subroutine startup
    ...
    use modglobal,         only : initglobal,iexpnr,runtime, dtmax,dtav_glob,timeav_glob,&
                                  ...
                                  lmoist,lcoriol,igrw_damp,geodamptime,cu, cv,ifnamopt,fname_options,llsadv,&
    ...
    namelist/PHYSICS/ &
        ...
        lcoriol,igrw_damp,geodamptime,ltimedep,irad,timerad,iradiation,rad_ls,rad_longw,rad_shortw,rad_smoke,useMcICA,&
