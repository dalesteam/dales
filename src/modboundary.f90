...
!>
  subroutine initboundary
    ...
    use modmpi,    only : myid, comm3d, mpi_logical, my_real	!GT added
    ...
    call mpi_bcast(lboundopen,              1, MPI_LOGICAL,   0, comm3d, ierr)	!GT added
    call mpi_bcast(fillvalues,		nsv, MY_REAL, 0, comm3d, ierr)	!GT added 
