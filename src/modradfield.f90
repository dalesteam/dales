...
!> Initializing fielddump. Read out the namelist, initializing the variables
  subroutine initradfield
    ...
    call ncinfo(ncname( 7,:),'rsdt','TOM incoming shortwave flux','W/m2','tt0t')
    call ncinfo(ncname( 8,:),'rsut','TOM outgoing shortwave flux','W/m2','tt0t')
    call ncinfo(ncname( 9,:),'rlut','TOM outgoing longwave flux','W/m2','tt0t')
    ...
    call ncinfo(ncname(25,:),'rsdtoa','TOA incoming shortwave flux','W/m2','tt0t')
    call ncinfo(ncname(26,:),'rsutoa','TOA outgoing shortwave flux','W/m2','tt0t')
    call ncinfo(ncname(27,:),'rlutoa','TOA outgoing longwave flux','W/m2','tt0t')
    call ncinfo(ncname(28,:),'rsutoacs','TOA outgoing shortwave flux - clear sky','W/m2','tt0t')
    call ncinfo(ncname(29,:),'rlutoacs','TOA outgoing longwave flux - clear sky','W/m2','tt0t')
  ...
  subroutine sample_radfield
    ...
    field_2D_mn (2:i1,2:j1,25) = field_2D_mn (2:i1,2:j1,25) + SW_dn_TOA(2:i1,2:j1)    !rsdtoa,  TOA incoming shortwave flux
    field_2D_mn (2:i1,2:j1,26) = field_2D_mn (2:i1,2:j1,26) + SW_up_TOA(2:i1,2:j1)    !rsutoa,  TOA outgoing shortwave flux
    field_2D_mn (2:i1,2:j1,27) = field_2D_mn (2:i1,2:j1,27) + LW_up_TOA(2:i1,2:j1)    !rlutoa,  TOA outgoing longwave flux
    field_2D_mn (2:i1,2:j1,28) = field_2D_mn (2:i1,2:j1,28) + SW_up_ca_TOA(2:i1,2:j1) !rsutoacs,TOA outgoing shortwave flux - clear sky
    field_2D_mn (2:i1,2:j1,29) = field_2D_mn (2:i1,2:j1,29) + LW_up_ca_TOA(2:i1,2:j1) !rlutoacs,TOA outgoing longwave flux - clear sky
