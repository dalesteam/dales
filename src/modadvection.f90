...
! Vertical advection
  ...
  select case(iadv_mom)
    case(iadv_cd2)
      ! Horizontal advection
      call vadvecu_2nd(u0,up,istart,iend,jstart,jend,merge(istart+1, istart, (lboundary(1) .and. .not. lperiodic(1))),iend,jstart,jend))
      call vadvecv_2nd(v0,vp,istart,iend,jstart,jend,istart,iend,merge(jstart+1, jstart, (lboundary(3) .and. .not. lperiodic(3))),jend))
      call vadvecw_2nd(w0,wp,istart,iend,jstart,jend)
    case(iadv_5th)
!       !if (.not. leq) stop "advec_5th does not support a non-uniform vertical grid."
      call vadvecu_5th(u0,up,istart,iend,jstart,jend,merge(istart+1, istart, (lboundary(1) .and. .not. lperiodic(1))),iend,jstart,jend))
      call vadvecv_5th(v0,vp,istart,iend,jstart,jend,istart,iend,merge(jstart+1, jstart, (lboundary(3) .and. .not. lperiodic(3))),jend))
    ...
    case(iadv_cd6)
!       !if (.not. leq) stop "advec_6th does not support a non-uniform vertical grid."
      call vadvecu_6th(u0,up,istart,iend,jstart,jend,merge(istart+1, istart, (lboundary(1) .and. .not. lperiodic(1))),iend,jstart,jend))
      call vadvecv_6th(v0,vp,istart,iend,jstart,jend,istart,iend,merge(jstart+1, jstart, (lboundary(3) .and. .not. lperiodic(3))),jend))
