...
!> Performs the SFS - budget calculations
  subroutine do_gensbbudget
    ...
    !----------------------------
    call slabsum(sbshrav ,sbshr ,2,i1,2,j1,1,k1)
    call slabsum(sbbuoav ,sbbuo ,2,i1,2,j1,1,k1)
    call slabsum(sbdissav,sbdiss,2,i1,2,j1,1,k1)
    call slabsum(ekmav   ,ekm   ,2,i1,2,j1,1,k1)
