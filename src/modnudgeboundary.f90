...
contains
    ...
    subroutine initnudgeboundary
        ...
        call D_MPI_BCAST(lnudge_boundary,   1, 0, comm3d, mpierr)
        call D_MPI_BCAST(lnudge_boundary_sv,1, 0, comm3d, mpierr)
        call D_MPI_BCAST(lperturb_boundary, 1, 0, comm3d, mpierr)
        call D_MPI_BCAST(lnudge_w,          1, 0, comm3d, mpierr)

        call D_MPI_BCAST(perturb_blocksize, 1, 0, comm3d, mpierr)

        call D_MPI_BCAST(nudge_offset,      1, 0, comm3d, mpierr)
        call D_MPI_BCAST(nudge_width,       1, 0, comm3d, mpierr)
        call D_MPI_BCAST(nudge_radius,      1, 0, comm3d, mpierr)
        call D_MPI_BCAST(nudge_tau,         1, 0, comm3d, mpierr)

        call D_MPI_BCAST(perturb_offset,    1, 0, comm3d, mpierr)
        call D_MPI_BCAST(perturb_width,     1, 0, comm3d, mpierr)
        call D_MPI_BCAST(perturb_radius,    1, 0, comm3d, mpierr)
        call D_MPI_BCAST(perturb_ampl,      1, 0, comm3d, mpierr)
        call D_MPI_BCAST(perturb_zmax,      1, 0, comm3d, mpierr)

        call D_MPI_BCAST(dt_input_lbc,      1, 0, comm3d, mpierr)
