  ...
  subroutine initgenstat
    ...
    if(myid==0)then
      ...
      if (lnetcdf) then
        ...
        call ncinfo(ncname(12,:),'wthls','SFS-Theta_l flux','K m/s','mt')
        call ncinfo(ncname(13,:),'wthlr','Resolved Theta_l flux','K m/s','mt')
        call ncinfo(ncname(14,:),'wthlt','Total Theta_l flux','K m/s','mt')
        call ncinfo(ncname(15,:),'wthvs','SFS-buoyancy flux','K m/s','mt')
        call ncinfo(ncname(16,:),'wthvr','Resolved buoyancy flux','K m/s','mt')
        call ncinfo(ncname(17,:),'wthvt','Total buoyancy flux','K m/s','mt')
