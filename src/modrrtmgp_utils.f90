...
!
!
!> Utilities for RTE-RRTMGP.
!!
!! Adopted from rte-rrtmgp/rrtmgp/data-loading-examples/mo_optics_utils_rrtmgp.F90
module modrrtmgp_utils
  ...
  character(len=*), parameter :: modname = 'modrrtmgp_utils'

  private
  public :: load_gas_optics, load_cloud_optics, load_aerosol_optics, stop_on_err
