       ...
       if (lxz) then
        ...
        if (lxy) then
           do cross=1,nxy
              ...
              do n = 1,nsv
                call ncinfo(ncname2(10+n,:), tracer_prop(n)%tracname, tracer_prop(n)%traclong//' specific concentration', tracer_prop(n)%unit, 'tt0t')
              enddo
           ...
           do cross=1,nyz
              if (crossortho(cross) >= 2 .and. crossortho(cross) <= i1) then
                 ...
                 do n = 1,nsv
                    ...
                    call ncinfo(ncname3(10+n,:), tracer_prop(n)%tracname, tracer_prop(n)%traclong//' specific concentration', tracer_prop(n)%unit, '0ttt')
                 enddo
