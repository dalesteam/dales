  ...
  subroutine initcrosssection
   ...
   implicit none
    ...
    !if (myid==0) then  ! remnant of slab parallelization - either all do this or myidx == 0
      ...
      call ncinfo(ncname1( 12,:),'tkexz','xz crosssection of sqrt(turbulent kinetic energy)','-','t0tt')
    ...
    do cross=1,nxy
      ...
      call ncinfo(ncname2(12,:),'tkexy','xy crosssection of sqrt(turbulent kinetic energy)','-','t0tt')
    ...
    call ncinfo(ncname3(12,:),'tkeyz','yz crosssection of sqrt(turbulent kinetic energy)','-','t0tt')
