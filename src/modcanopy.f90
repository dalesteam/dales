...
!!  Emissions of heat, moisture and scalars by trees (effect on center of the grid)
  ...
  subroutine canopyu (p)
    ...
    do k=1,ncanopy
      ...
      p(2:i1,2:j1,k) = p(2:i1,2:j1,k) - ftau * ucor(2:i1,2:j1,k)
    end do

    return
  end subroutine canopyu

  subroutine canopyv (p)
    ...
    do k=1,ncanopy
      ...
      p(2:i1,2:j1,k) = p(2:i1,2:j1,k) - ftau * vcor(2:i1,2:j1,k)
    end do

    return
  end subroutine canopyv

  subroutine canopyw (p)
    ...
    do k=2,(ncanopy+1)
      ...
      p(2:i1,2:j1,k) = p(2:i1,2:j1,k) - ftau * w0(2:i1,2:j1,k)
    end do

    return
  end subroutine canopyw

  subroutine canopye (p)
    ...
    do k=1,ncanopy
      ...
      p(2:i1,2:j1,k) = p(2:i1,2:j1,k) - e120(2:i1,2:j1,k) * ftau
    end do

    return
  end subroutine canopye

  subroutine canopyc (p, flux_top, flux_surf, alpha, pai)
    ...
    p(2:i1,2:j1,1:ncanopy) = p(2:i1,2:j1,1:ncanopy) + tendency
