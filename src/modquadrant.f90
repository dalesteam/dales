...
!
!  Copyright 1993-2026 Delft University of Technology, Wageningen University, Utrecht University, KNMI, Max Planck Institute for Chemistry
!
module modquadrant
...
!> Initialization routine, reads namelists and inits variables
  subroutine initquadrant
    ...
    call finish(routine, "quadrant-hole statistics not supported on GPU")
#endif
