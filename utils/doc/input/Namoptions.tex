...
\setcounter{page}{1}
This document gives an overview of all namelist options in version 4 of the Dutch Atmospheric Large Eddy Simulation (DALES) model. Only general information concerning these options is presented. For more detailed information about the model, the reader is referred to \citet{Heus2009}. \\
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  ...
  \qquad	&		&				&							&\\
  \multirow{10}{*}{\begin{tabular}{@{\hspace{0cm}}l}iadv\_mom\\iadv\_tke\\iadv\_thl\\iadv\_qt\\iadv\_sv(1:nsv) \end{tabular}$\left. \begin{tabular}{l} \\ \\ \\ \\ \\ \end{tabular} \right\}$} & \multirow{10}{*}{\begin{tabular}{@{\hspace{0cm}}l}5\\-1\\-1\\-1\\-1
...
\subsection{Namelist NAMDE}\label{par:namde}
\begin{center}
	  \tablefirsthead{
        \multicolumn{1}{c}{Option} & \multicolumn{1}{c}{Default} & \multicolumn{1}{c}{Possible values} & \multicolumn{1}{c}{Description} & \multicolumn{1}{c}{Unit}\\
        \hline &&&&\\
...
\begin{supertabular}{|l|p{2cm}|p{4cm}|p{6cm}|l|}
  iDE	& 1	& $x \in \mathbb{N^*}, \quad 1 \le x \le \text{nsv}$	& Scalar field used as extinction profile & -\\
  laero   & .false.		& $x\in\{\text{.false.},\text{.true.}\}$	& Switch aerosol/clouds	& -\\
  SSA   & 0.999		& $x \in \mathbb{N}, \quad 0 \le x \le 0.999$	& Single scattering albedo of the aerosol particles & -\\
\end{supertabular}
\end{center}
