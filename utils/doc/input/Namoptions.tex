...
%  & & & &\\
  ...
  sw0		& 1368.22	& $x \in \mathbb{R}, \quad x \ge 0$	& Solar constant (TOA).  SWD at TOA = $\text{sw0}*\cos(\mu)$  & W m$^{-2}$\\
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  ...
  sgs\_surface\_fix & .false.	& $x\in\{\text{.false.},\text{.true.}\}$	& Switch to apply a fix to the coupling of SFS TKE to the surface (experimental) & - \\
...
\begin{supertabular}{|l|p{1.6cm}|p{4.8cm}|p{6cm}|l|}
  ...
  qrminout	& $10^{-13}$	& $x \in \mathbb{R}, \quad x \geq 0$	& Minimum value of qr to output. Smaller values rounded to 0 for better compression. & kg/kg \\
\end{supertabular}
\end{center}
